...
const state = JSON.parse(await readFile(`${projectRoot}/video/output/RevPilot_demo_V4_etat.json`, 'utf8'))
...
if (duration < 60 || duration > 75) errors.push(`Durée incorrecte : ${duration.toFixed(2)} s.`)
