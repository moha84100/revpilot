...
const dashboard = source
  .replace('<title>Logiciel revenue management hôtel | RevPilot</title>', '<title>RevPilot — Pilotage hôtelier</title>')
...
<html lang="fr">
  ...
  <body><main><small>Erreur 404</small><h1>Cette page n’existe pas.</h1><p>Revenez à l’accueil de RevPilot pour découvrir le produit ou ouvrir le tableau de bord.</p><a href="/revpilot/">Revenir à l’accueil</a></main></body>
</html>`
